...
`;
  ...
  return (
    ...
    >
      ...
      <SidebarContent className="dark:bg-zinc-900 bg-opacity-90 border-r-0">
        <SidebarGroup>
                                      ...
                                      {showContext?.map((item) => (
                                        <CommandItem key={item.fileId}>
                                          <div className="flex justify-between items-center w-full">
                                            ...
                                            <Button
                                              className="x-[9999999] rounded-full hover:bg-zinc-800"
                                              onClick={() => {
                                                handleErase(
                                                  chatId,
                                                  item.fileId,
      ...
      <SidebarFooter className=" bg-opacity-90 border-muted-foreground/50 dark:bg-zinc-900">
        {showProgress && (
