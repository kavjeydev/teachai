        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-2xl text-slate-600 dark:text-slate-300 leading-relaxed mb-6">
              Build AI applications where users{" "}
              <span className="text-green-700 dark:text-green-300 font-semibold">
                trust uploading sensitive documents
              </span>{" "}
              because developers cannot access raw files.
            </p>
          ...
          <CardContent className="p-8">
            ...
            <div className="bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-green-950/30 dark:via-blue-950/30 dark:to-purple-950/30 rounded-2xl p-8 mb-8 border border-green-200 dark:border-green-800">
              <div className="grid md:grid-cols-3 gap-6 items-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    Each user gets their own private sub-chat
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Developers get AI responses, never raw files
                  </p>
                </div>
                <div className="text-center">
              ...
              <div className="text-center mt-8">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
                  ...
                  developers cannot access their files - only AI-generated
                  insights are available, leading to higher engagement and
                  enterprise adoption.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <span className="text-sm text-green-700 dark:text-green-300">
                      Get AI responses about user's data
                    </span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm text-green-700 dark:text-green-300">
                      Enable direct user file uploads
                    </span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-sm text-green-700 dark:text-green-300">
                      View usage analytics (anonymized)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h4 className="font-semibold text-red-800 dark:text-red-200 mb-4 flex items-center gap-2">
                  <AlertCircle className="w-5 h-5" />❌ What You CANNOT Do
                </h4>
                <div className="space-y-3">
            ...
            <div className="bg-slate-900 rounded-2xl p-6 shadow-2xl">
              ...
              <pre className="text-green-400 text-sm overflow-x-auto">
                {`// 🔐 SECURE OAUTH WORKFLOW - User-Controlled Authentication

// 1. User clicks "Connect with Trainly" in your app
function connectToTrainly(chatId) {
  // Seamless OAuth redirect (industry standard)
...
// 2. Handle OAuth callback (user gets private token)
app.get('/auth/callback', async (req, res) => {
  ...
  // CRITICAL: Store on user's device only (you never see it)
  res.send(\`
    <script>
...
// 3. User queries their data (using their private token)
...
// You get AI response, user controls authentication! 🔒`}
              </pre>
              <Button
                variant="outline"
                size="sm"
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-6 bg-gradient-to-r from-blue-50/50 to-green-50/50 dark:from-blue-950/30 dark:to-green-950/30">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <code className="font-mono text-lg">
                    /v1/chats/&#123;chat_id&#125;/oauth/authorize-url
                  </code>
                </div>
                <p className="text-slate-600 dark:text-slate-400 mb-3">
                  Generate OAuth authorization URL for seamless user
                  authentication.{" "}
                  <strong>Each chat is treated as an app</strong> with OAuth
                  capabilities.
                </p>
  ...
  "requested_capabilities": ["ask", "upload"]
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-6 bg-gradient-to-r from-green-50/50 to-purple-50/50 dark:from-green-950/30 dark:to-purple-950/30">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-3">
                  ...
                  <strong>Returns AI responses only</strong> - never raw files
                  or content.
                </p>
                <div className="bg-slate-900 rounded-lg p-4">
  ...
  "include_citations": true
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-6 bg-gradient-to-r from-purple-50/50 to-pink-50/50 dark:from-purple-950/30 dark:to-pink-950/30">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-3">
                  ...
                  <strong>Files bypass your servers</strong> - uploaded directly
                  to user's private namespace.
                </p>
                <div className="bg-slate-900 rounded-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold mb-4 text-green-700 dark:text-green-300 flex items-center gap-2">
                  <CheckCircle className="w-5 h-5" />✅ Tests That Should PASS
                </h4>
                <div className="space-y-3">
              ...
              <div>
                <h4 className="font-semibold mb-4 text-red-700 dark:text-red-300 flex items-center gap-2">
                  <AlertCircle className="w-5 h-5" />❌ Tests That Should FAIL
                </h4>
                <div className="space-y-3">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-amber-700 dark:text-amber-300 font-medium leading-relaxed">
                    <strong>Single-user or internal applications only.</strong>{" "}
                    For apps with multiple users, use the Privacy-First API
                    above to ensure complete data isolation and user trust.
                  </p>
        ...
        <Card className="border-2 border-green-200 dark:border-green-800 shadow-xl shadow-green-500/10">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-6 max-w-2xl mx-auto">
              Start building applications where users trust uploading sensitive
              documents because they know you can't access their files.
            </p>
