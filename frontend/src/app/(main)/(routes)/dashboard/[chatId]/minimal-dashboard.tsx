                  ...
                  <div key={index} className="mb-4">
                    {msg.sender === "user" ? (
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl px-4 py-3 max-w-[85%] text-sm">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex items-end space-x-2">
                <div className="flex-1 relative">
                  <textarea
                    className="w-full resize-none border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
      ...
      fallback={
        <div className="flex h-screen items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading full dashboard...</p>
