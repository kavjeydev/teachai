...
// EXTREME: Load the entire heavy dashboard lazily
...
// MINIMAL shell - loads instantly, then enhances
function Dashboard({ params }: ChatIdPageProps) {
  return <HeavyDashboard params={params} />;
}

// This is now the minimal wrapper that loads instantly
function MinimalDashboardShell({ params }: ChatIdPageProps) {
...
function OriginalDashboard({ params }: ChatIdPageProps) {
